...
//apply the animation ( fade In ) to your LAyout
    ...
    public void startgame(View view) {
        ...
        Intent game_intent = new Intent(this, Afterstart.class);
        game_intent.putExtra("easy", easy);
        game_intent.putExtra("medium", medium);
        game_intent.putExtra("hard", hard);
        game_intent.putExtra("impossible", impossible);
        game_intent.putExtra("playersnames", players);
        game_intent.putExtra("player1ax", player1ax);
        game_intent.putExtra("selectedsingleplayer", selectedSinglePlayer);
